                ...
                <form @submit.prevent="onSubmit">
                    <div class="field">
                        <p class="control has-icons-left has-icons-right">
                            <input v-model="email" class="input" :class="{ 'is-danger': ErrorMessage }" type="email" placeholder="Email">
                    ...
                    <div class="field">
                        <p class="control has-icons-left">
                            <input v-model="password" class="input" :class="{ 'is-danger': ErrorMessage }" type="password" placeholder="Password">
                            <span class="icon is-small is-left">
